...
public class ProvincesRecyclerAdapter
        extends RecyclerView.Adapter<ProvincesRecyclerAdapter.ViewHolder> {
    ...
    final private ArrayList<Province> data;
    ...
    @NonNull
    @Override
    public ProvincesRecyclerAdapter.ViewHolder onCreateViewHolder(
    ...
    public void onBindViewHolder(
            @NonNull ProvincesRecyclerAdapter.ViewHolder holder, int position) {
